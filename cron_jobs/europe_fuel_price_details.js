...
//Fonksiyonlar
const format_string_to_number = require("../MyFunctions/format_string_to_number.js");

var EURO_STAT_OIL_URL = process.env.EURO_STAT_OIL_URL;
...
async function europe_fuel_price_details(){
    ...
    console.log("Europe gasoline prices automation completed. ");
    return true;
};
